<template>
  ...
  :key="ing.id"
  :class="{
    'alert-stock': ing.alertLevel === 'BAS',
    'critical-stock': ing.alertLevel === 'CRITIQUE'
  }"
>
  ...
  <span
    v-if="ing.alertLevel === 'BAS' || ing.alertLevel === 'CRITIQUE'"
    :style="{
      color: ing.alertLevel === 'CRITIQUE' ? '#e53935' : '#ff9800',
      fontWeight: 'bold'
    }"
  >
    ⚠️
    <template v-if="ing.alertLevel === 'CRITIQUE'">Stock critique</template>
